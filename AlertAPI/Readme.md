# Alert API
## Overview
Alert API app showcases the following APIs:

- [kony.ui.Alert](https://docs.kony.com/konylibrary/visualizer/viz_api_dev_guide/Default.htm#kony.ui_functions_alert.htm#top%3FTocPath%3DAlert%2520API%7C_____1)
...
2. From the main menu select **Project** → **Import** → **Local Project** → **Open as New Project**. Select the AlertAPI zipped folder and click Open.
